...
describe('useRootClose shadow', () => {
  let attachTo;

  beforeEach(() => {
    attachTo = document.createElement('div');
    attachTo.attachShadow({ mode: 'open' })
    document.body.appendChild(attachTo);
  });

  afterEach(() => {
    ReactDOM.unmountComponentAtNode(attachTo.shadowRoot);
    document.body.removeChild(attachTo);
  });
  ...
  function shouldCloseOn(clickTrigger, eventName) {
    ...
    it('should close when clicked outside', () => {
      ...
      mount(<Wrapper onRootClose={spy} />, { attachTo: attachTo.shadowRoot });

      simulant.fire(attachTo.shadowRoot.getElementById('my-div'), eventName);
    ...
    it('should not close when disabled', () => {
      let spy = sinon.spy();
      mount(<Wrapper onRootClose={spy} disabled />, { attachTo: attachTo.shadowRoot });
    ...
    it('should close when inside another RootCloseWrapper', () => {
      ...
      mount(<Outer />, { attachTo: attachTo.shadowRoot });
